...
def extract_ij_responses(analysis_dir, roi_index, roiset_path=None):
    ...
    (_, _), (_, thorsync_dir) = keys_and_paired_dirs[0]
    ...
    # TODO refactor this + hong2p.util.ij_traces, to share a bit more code (maybe break
    # out some of ij_traces into another helper fn?)
